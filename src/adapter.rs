...
pub mod tests {
    ...
    */
    pub async fn test_create(http_addr: &String) {
        use casbin::prelude::*;
    ...
    */
    pub async fn test_create_with_pool(http_addr: &String) {
        use casbin::prelude::*;
    ...
    */
    pub async fn test_adapter(http_addr: &String) {
        use casbin::prelude::*;
        ...
        let res = adapter.save_policy(e.get_mut_model()).await;
        if let Err(err) = &res {
